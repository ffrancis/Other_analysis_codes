...
####
# for a in pairwise2.align.globalxx(seq_1, seq_2):
...
stretcher_cline = StretcherCommandline(asequence=seq_1, bsequence=seq_2, gapopen=16, gapextend=4, outfile="stretcher.txt")
# print stretcher_cline
stdout, stderr = stretcher_cline()
# print(stdout + stderr)

### read alignment file
# align = AlignIO.read("stretcher.txt", "emboss")
align = AlignIO.read("stretcher.txt", "markx0")
print(align)
'''
